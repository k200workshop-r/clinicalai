...
app.get("/api/health", (req, res) =>
  res.json({ ok: true, build: BUILD, model: MODEL, thinking: (process.env.GEMINI_THINKING || "low").trim().toLowerCase(), hasKey: !!API_KEY, storage: store.usingRedis() ? "key-value" : "local-file" }));
